...
def run():
    ...
    exec_sql("IF OBJECT_ID('SP_OBTENER_FACTURAS', 'P') IS NOT NULL DROP PROCEDURE SP_OBTENER_FACTURAS;")
    exec_sql("IF OBJECT_ID('SP_CREAR_FACTURA', 'P') IS NOT NULL DROP PROCEDURE SP_CREAR_FACTURA;")
    exec_sql("IF OBJECT_ID('SP_CREAR_SOLICITUD_SERVICIO', 'P') IS NOT NULL DROP PROCEDURE SP_CREAR_SOLICITUD_SERVICIO;")
    exec_sql("IF OBJECT_ID('SP_CREAR_GUIA_DESPACHO', 'P') IS NOT NULL DROP PROCEDURE SP_CREAR_GUIA_DESPACHO;")
    exec_sql("IF OBJECT_ID('SP_ACTUALIZAR_SOLICITUD_DE_SERVICIO', 'P') IS NOT NULL DROP PROCEDURE SP_ACTUALIZAR_SOLICITUD_DE_SERVICIO;")
    exec_sql("IF OBJECT_ID('SP_OBTENER_EQUIPOS_EN_BODEGA', 'P') IS NOT NULL DROP PROCEDURE SP_OBTENER_EQUIPOS_EN_BODEGA;")
