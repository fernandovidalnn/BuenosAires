 ...
 * generated in the buenosaires.proxy.wsstockproducto package. 
...
public class ObjectFactory {
    ...
    private final static QName _StockProductoResponseStockProductoResult_QNAME = new QName("http://tempuri.org/", "StockProductoResult");
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: buenosaires.proxy.wsstockproducto
     * 
     */
     ...
     *     the new instance of {@link JAXBElement }{@code <}{@link Respuesta }{@code >}
     */
    @XmlElementDecl(namespace = "http://tempuri.org/", name = "StockProductoResult", scope = StockProductoResponse.class)
    public JAXBElement<Respuesta> createStockProductoResponseStockProductoResult(Respuesta value) {
        return new JAXBElement<Respuesta>(_StockProductoResponseStockProductoResult_QNAME, Respuesta.class, StockProductoResponse.class, value);
    }
